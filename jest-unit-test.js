// Some Jest unit test for sideshiftAPI.js
...
describe('API Client', () => {
  ...
  beforeEach(() => {
    client = new SideshiftAPI({ secret: "secret_here", id: "id_here", commisssionRate: "0.5", verbose: true });
    ...
    client.verbose = true;
    client.SIDESHIFT_SECRET = "secret_here";
    client.SIDESHIFT_ID = "id_here";
