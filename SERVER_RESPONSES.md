...
**note:** The coin can be coin-network or if network is omitted, it will default to the mainnet. E.g btc-bitcoin, btc-mainnet or btc all return the BTC on chain logo. btc-liquid return the Liquid BTC logo.
