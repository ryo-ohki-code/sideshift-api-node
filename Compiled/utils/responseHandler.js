 ...
 */
function _handleResponse(response, url, options, verbose) {
            ...
            switch (_c.label) {
                case 0:
                    if (verbose) {
                        ...
                        console.log('Headers:', (options === null || options === void 0 ? void 0 : options.headers) ? (0, headers_1._filterHeaders)(options.headers) : 'None');
                ...
                case 8:
                    error = (0, error_1._createError)("HTTP ".concat(response === null || response === void 0 ? void 0 : response.status, " ").concat(response === null || response === void 0 ? void 0 : response.statusText), response, url, options, errorData.error || errorData);
                    throw error;
